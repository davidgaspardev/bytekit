...
void copy_test(const char* data) {
  ...
  log_info(
      "Copying the characters of the '%s' string to the data_copy variable",
      data);
  ...
  log_info(
      "Copying the first %i characters of the '%s' string to the data_copy "
      "variable",
      len, data);
  ...
  log_info(
      "Copying the first %i characters of the '%s' string after the %iº "
      "character to the data_copy variable",
